 ...
 * @author hebod
 */
public class FrmLogicos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tfCaracter2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfCaracter2ActionPerformed(evt);
            }
        });
    ...
    private void bVerificar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar1ActionPerformed
        ...
        float num1 = Integer.parseInt(tfNum1.getText());
        float num2 = Integer.parseInt(tfNum2.getText());
        if(num1 == num2){
    ...
    private void bCalcular2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular2ActionPerformed
        // TODO add your handling code here:
        float num1 = Integer.parseInt(tfNum3.getText());
        float num2 = Integer.parseInt(tfNum4.getText());
        float mayor; 
        if(num1 > num2){
            mayor = num1;
        }else if(num1 == num2){
    ...
    private void bCalcular3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular3ActionPerformed
        // TODO add your handling code here:
        float num1 = Integer.parseInt(tfNum5.getText());
        float num2 = Integer.parseInt(tfNum6.getText());
        float menor; 
        if(num1 < num2){
            menor = num1;
        }else if(num1 == num2){
    ...
    private void bCalcular4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular4ActionPerformed
        // TODO add your handling code here:
        float num1 = Integer.parseInt(tfNum7.getText());
        float num2 = Integer.parseInt(tfNum8.getText()); 
        if(num1 >= num2){
    ...
    private void bCalcular5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular5ActionPerformed
        // TODO add your handling code here:
        float num1 = Integer.parseInt(tfNum9.getText());
        float num2 = Integer.parseInt(tfNum10.getText()); 
        if(num1 <= num2){
            JOptionPane.showMessageDialog(null, "Verdadero");
        }
        else{
    ...
    private void bVerificar6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar6ActionPerformed
        // TODO add your handling code here:
        String char1 = tfCaracter1.getText();
        String char2 = tfCaracter2.getText();
    ...
    private void tfCaracter2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfCaracter2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfCaracter2ActionPerformed

    private void bVerificar7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar7ActionPerformed
        // TODO add your handling code here:
        String char1 = tfCaracter3.getText();
        String char2 = tfCaracter4.getText();
        if(char1.equals(char2)){
            JOptionPane.showMessageDialog(null, "Son iguales");
        }
        else{
    ...
    private void bVerificar8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar8ActionPerformed
        // TODO add your handling code here:
        String char1 = tfCadena1.getText();
        String char2 = tfCadena2.getText();
        if(char1.equals(char2)){
            JOptionPane.showMessageDialog(null, "Son iguales");
        }
        else{
    ...
    private void bCalcular9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular9ActionPerformed
        // TODO add your handling code here:
        String char1 = tfCadena3.getText();
        String char2 = tfCadena4.getText();
        if(char1.length() < char2.length()){
            JOptionPane.showMessageDialog(null, char2,"La mayor es: ", JOptionPane.INFORMATION_MESSAGE);
        }else{
            JOptionPane.showMessageDialog(null, char1,"La mayor es: ", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void bVerificar10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar10ActionPerformed
        // TODO add your handling code here:
        int num = Integer.parseInt(tfNum11.getText());
        if(num < 0){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmLogicos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmLogicos().setVisible(true);
            }
        });
    }
