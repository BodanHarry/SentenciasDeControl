 ...
 * @author hebod
 */
public class FrmArreglo1 extends javax.swing.JFrame {

        Arreglo1 arre1 = new Arreglo1();
        ArrayList array = new ArrayList();
        DefaultListModel modelo = new DefaultListModel();
        DefaultListModel models = new DefaultListModel();
        
    /**
     * Creates new form FrmArreglo1
     */
    public FrmArreglo1() {
        initComponents();
        lsNumeros.setModel(modelo);
        lsMayores.setModel(models);
    }
    ...
    private void initComponents() {
        ...
        pArregloLayout.setHorizontalGroup(
            ...
            .addGroup(pArregloLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tfMultiplo, javax.swing.GroupLayout.DEFAULT_SIZE, 73, Short.MAX_VALUE))
        );
        ...
        tfPromedio.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfPromedioActionPerformed(evt);
            }
        });
        ...
        pInfoArregloLayout.setHorizontalGroup(
            ...
            .addGroup(pInfoArregloLayout.createSequentialGroup()
                .addGroup(pInfoArregloLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(pInfoArreglo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void bSetTamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSetTamActionPerformed
        if (tfTam.getText()==null) {
            JOptionPane.showMessageDialog(null, "Digite un límite para el arreglo");
        }else{
    ...
    private void bAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarActionPerformed
        ...
        int num = Integer.parseInt(tfElemento.getText());
        int mul = Integer.parseInt(tfMultiplo.getText());
        
        boolean condicion = arre1.evaluarMultiplo(num, mul);
        
        int tamano = Integer.parseInt(tfTam.getText());
        
        if (array.size() == tamano){
            ...
            if (condicion){
                ...
                JOptionPane.showMessageDialog(null, "Elemento no cumple");
            }
        }      
    ...
    private void bMostrarMayorMenorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bMostrarMayorMenorActionPerformed
        ...
        for(int i=0; i<array.size();i++){
            valor = String.valueOf(array.get(i));
            elemento = Integer.parseInt(valor);
            arreglo[i]= elemento;
        }
        ...
        String mayors = String.valueOf(mayor);
        String menors = String.valueOf(menor);
       
        
        this.tfMayor.setText(mayors);
        this.tfMenor.setText(menors);
    }//GEN-LAST:event_bMostrarMayorMenorActionPerformed

    private void tfPromedioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfPromedioActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfPromedioActionPerformed
    ...
    private void bMostrarPromedioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bMostrarPromedioActionPerformed
        ...
        int prom = suma / arreglo.length;
        
        String proms = String.valueOf(prom);
        
        this.tfPromedio.setText(proms);
    ...
    private void bMostrarMayoresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bMostrarMayoresActionPerformed
        ...
        for (int j=0; j<= array.size(); j++){
            valor = String.valueOf(array.get(j));
            elemento = Integer.parseInt(valor);
            if(elemento>=prom){
                models.addElement(array.get(j));
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmArreglo1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmArreglo1().setVisible(true);
            }
        });
    }
