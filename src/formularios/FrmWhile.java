 ...
 * @author hebod
 */
public class FrmWhile extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmWhile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
